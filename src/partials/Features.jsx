    ...
    <section className="relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className='flex justify-center h-full w-[80%] order-1 bg-[url("../public/pole.png")] bg-no-repeat bg-center'>
            <motion.div 
              animate={{ y:scy*0.25 }}
              transition={{ type: 'spring', stiffness: 40, damping: 10 }}
            ref={slide} ><img className=' z-30  left-[98px] ' src='../public/sliding.png'/></motion.div>
